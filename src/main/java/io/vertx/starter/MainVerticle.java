...
public class MainVerticle extends AbstractVerticle {
  ...
  private Future<Void> startHttpServer() {
    ...
    router.get("/save").handler(this::pageUpdateHandler);
    router.get("/create").handler(this::pageCreateHandler);
    router.get("/delete").handler(this::pageDeletionHandler);
      ...
      if (car.succeeded()) {
        ...
        connection.query(SQL_ALL_PAGES, res -> {
          ...
          if (res.succeeded()) {
            ...
            templateEngine.render(routingContext.data(), "template/index.ftl", ar -> {
              if (ar.succeeded()) {
